...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-4 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Einloggen</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p class="mt-8 text-center text-sm text-gray-500">
        Noch kein Mitglied?
      <a href="{{ route('register') }}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Registrieren Sie sich hier!</a>
    </p>
  </div>
</div>
@endsection
