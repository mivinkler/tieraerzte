        ...
        <menu class="text-gray-700 flex flex-col w-[12vw]">
            <button class="relative text-sm focus:outline-none group bg-slate-500 hover:bg-slate-600">
                ...
                <div class="absolute z-10 flex-col items-start hidden w-full pb-1 bg-white shadow-lg group-focus:flex">
                    <a class="w-full pl-8 py-2 text-left hover:bg-gray-300" href="#">Home</a>
                    <a class="w-full pl-8 py-2 text-left hover:bg-gray-300" href="#">Praxis suchen</a>
                    <a class="w-full pl-8 py-2 text-left hover:bg-gray-300" href="#">Praxis Profile</a>
                    <a class="w-full pl-8 py-2 text-left hover:bg-gray-300" href="#">Impressum</a>
                    <a class="w-full pl-8 py-2 text-left hover:bg-gray-300" href="#">AGB</a>
                </div>
            </button>
