        ...
        <form id="myForm" action="{{ route('praxis.index') }}" method="get" class="flex items-center h-14">
            <div name="filter_result" class="flex text-gray-600">
                <div class="px-1 pr-2 w-[4rem]">
                    <input type="text" name="title" id="name_title" placeholder="id" value="{{ request('title') }}" class="w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus-visible:outline focus-visible-2 focus-visible:outline-offset-1 focus-visible:outline-indigo-500">
                </div>
                <div class="pr-2 w-[20rem]">
                    <input type="text" name="title" id="name_title" placeholder="Praxis" value="{{ request('title') }}" class="w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus-visible:outline focus-visible-2 focus-visible:outline-offset-1 focus-visible:outline-indigo-500">
                </div>
                <div class="pr-2 w-[14rem]">
                    <input type="text" name="postcode" placeholder="Adresse" value="{{ request('postcode') }}" class="w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus-visible:outline focus-visible-2 focus-visible:outline-offset-1 focus-visible:outline-indigo-500">
                </div>
                ...
                <div class="pr-2 w-[12rem]">
                    <input type="text" name="postcode" placeholder="User" value="{{ request('postcode') }}" class="w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus-visible:outline focus-visible-2 focus-visible:outline-offset-1 focus-visible:outline-indigo-500">
                </div>
                <div class="pr-2 w-[14rem]">
                ...
                <div name="filter_result" class="flex items-center hover:bg-gray-50 h-[3rem]">
                    ...
                    <div class="px-4 flex gap-4 right ml-auto">
                        ...
                        <a href="{{ optional($praxis)->website }}" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="{{ $praxis->website ? '#71717a' : '#d1d3d9' }}" viewBox="0 0 122.88 122.88">
                                <title>Website</title>
                        ...
                        <div>
                            <form action="{{ route('admin.praxis.delete', $praxis->id) }}" method="post">
                                @csrf
                                @method('delete')
