...
@else
  <nav class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold text-sm hover:text-white py-1 px-3 border border-blue-500 hover:border-transparent rounded">
    <a href="{{ route('home')}}">
      Login
    </a>
  </nav>
